...
const QuickMenu = () => {
    ...
    var LocalItem = JSON.parse(localStorage.getItem("user_data"));
    var f_name = LocalItem.f_name;
    var l_name = LocalItem.l_name;
            ...
            <Dropdown as="li" className="ms-2">
                <Dropdown.Toggle
                    ...
                    <div className="avatar avatar-md avatar-indicators avatar-online">
                        <Image alt="avatar" src="https://cdn-icons-png.flaticon.com/512/6522/6522516.png" className="rounded-circle" />
                    </div>
                </Dropdown.Toggle>
                <Dropdown.Menu
